...
def get_log_filename():
    ...
    #return current_datetime.strftime(SETTINGS_SYSTEM_DEBMES_PATH+"/%Y-%m-%d_websokets.log")
    return current_datetime.strftime("/var/log/majordomo/%Y-%m-%d_websokets.log")
